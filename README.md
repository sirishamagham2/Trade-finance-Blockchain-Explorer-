...
The application is developed using **FastAPI** and follows modern backend architecture with secure authentication, modular code design, and scalable database integration. It ensures data security using JWT authentication and supports protected API endpoints for authorized users.
...
## 📂 Project Structure
app/ ├ main.py ├ database.py ├ models.py ├ auth.py ├ routes/ │    └ auth.py └ core/ └ security.py
---
...
5. Open API Docshttp://127.0.0.1:8000/docs
